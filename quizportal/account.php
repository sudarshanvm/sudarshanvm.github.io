...
if (@$_GET['q'] == 2)
    echo 'class="active"';
?>><a href="account.php?q=2"><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span>&nbsp;Results</a></li>
   </ul>
...
<span href="#" data-target="#login" style="color:lightyellow">Organized by Dept. Of ISE, R.V. College Of Engineering, Bengaluru<br><br></span></div>
